...
export const Features = () => {
  return (
    <>
      ...
      <section className='pb-8 pt-20 bg-[#ffdfc1] dark:bg-dark lg:pb-[70px] lg:pt-[120px] font-sans'>
        <div className='container'>
          <div className='-mx-4 flex flex-wrap'>
            <div className='w-full px-4'>
              <div className='mx-auto mb-12 max-w-[485px] text-center lg:mb-[70px]'>
                <span className='mb-2 block text-lg font-normal text-gray-700 dark:text-primary'>
                  {siteConfig('STARTER_FEATURE_TITLE')}
                </span>
                <h2 className='mb-3 text-3xl font-normal text-gray-800 dark:text-white sm:text-4xl md:text-[40px] md:leading-[1.2]'>
          ...
          <div className='-mx-4 flex flex-wrap'>
            <div className='w-full px-4 md:w-1/2 lg:w-1/4'>
              <div className='wow fadeInUp group mb-12' data-wow-delay='.1s'>
                ...
                <h4 className='mb-3 text-xl font-normal text-gray-800 dark:text-white'>
                  {siteConfig('STARTER_FEATURE_1_TITLE_1')}
                </h4>
                <p className='mb-8 text-gray-700 dark:text-dark-6 lg:mb-9'>
                  {siteConfig('STARTER_FEATURE_1_TEXT_1')}
                </p>
                <SmartLink
                  href={siteConfig('STARTER_FEATURE_1_BUTTON_URL', '')}
                  className='text-base font-normal text-gray-800 hover:text-primary dark:text-white dark:hover:text-primary'>
