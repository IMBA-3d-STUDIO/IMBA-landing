...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '02ab3b8678004aa69e9e415905ef32a5,en:2d28e69a0fc9815dbbf7f36ddf756fda',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Kris from IMBA Studio', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'An ordinary ', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://imbastudio.ca', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'IMBA STUDIO, Canada Made, Made in Canada, Made in NA, 3D Printing, Customizations', // 网站关键词 英文逗号隔开
