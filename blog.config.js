...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '2d28e69a0fc9815dbbf7f36ddf756fda?v=2d28e69a0fc9818792e9000cb3467469',
  THEME: process.env.NEXT_PUBLIC_THEME || 'srater', // 当前主题，在themes文件夹下可找到所有支持的主题；主题名称就是文件夹名，例如 example,fukasawa,gitbook,heo,hexo,landing,matery,medium,next,nobelium,plog,simple
